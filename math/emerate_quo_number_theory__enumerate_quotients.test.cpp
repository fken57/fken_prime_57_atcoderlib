...
// problem: number_theory/enumerate_quotients
// library: math/emerate_quo.hpp
...
// Injecting ../templete.hpp <- _fib/math/emerate_quo.hpp
...
// Injecting math/emerate_quo.hpp <- _fib/math/emerate_quo_number_theory__enumerate_quotients.test.cpp

// Skipping already injected math/emerate_quo.hpp

void solve(){
    ll N;
    cin >> N;
    vPll cnt=emerateQuo(N);
    cout << cnt.size() << '\n';
    for(auto v:cnt) cout << v.first << " ";
}
