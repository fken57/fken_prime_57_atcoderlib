...
// problem: data_structure/unionfind_with_potential
// library: DataStructure/PotentialDSU.hpp
...
#endif
// Injecting ../template.hpp <- _fib/DataStructure/PotentialDSU.hpp
...
// Injecting DataStructure/PotentialDSU.hpp <- _fib/DataStructure/PotentialDSU_data_structure__unionfind_with_potential.test.cpp
...
int main() {
    ...
    while (q--) {
        ...
        if (type == 0) {
            int difference;
            cin >> difference;
            cout << dsu.merge(v, u, mint998(difference)) << '\n';
